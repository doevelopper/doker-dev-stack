...
RUN wget -qO- "https://cmake.org/files/v3.13/cmake-3.13.2-Linux-x86_64.tar.gz" | tar --strip-components=1 -xz -C /opt/cmake
...
RUN export MAVEN_OPTS="-Dstyle.info=bold,green -Dstyle.project=bold,magenta -Dstyle.warning=bold,yellow -Dstyle.mojo=bold,cyan -Xmx1048m -Xms256m -XX:MaxPermSize=312M"
